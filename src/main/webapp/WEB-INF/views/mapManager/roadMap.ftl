...
<head>
	...
	<style>
		...
		.legend{position: absolute; z-index: 10; -moz-user-select: none;  right: 0px; top: 21px; left: auto; width:220px;}
...
.gis-mapgj .gis-mapgj-hand, .gis-mapgj .gis-mapgj-marquee,.gis-mapgj .gis-mapgj-diejia,.gis-mapgj .gis-mapgj-marquee-hover,.gis-mapgj .gis-mapgj-diejia-hover,.gis-mapgj .gis-mapgj-hand-hover,.gis-mapgj .gis-mapgj-circle,.gis-mapgj .gis-mapgj-circle-hover {
	float:right;
	direction: ltr;
	overflow: hidden;
	text-align: left;
...
.gis-mapgj .gis-mapgj-hand img, .gis-mapgj .gis-mapgj-marquee img,.gis-mapgj .gis-mapgj-diejia img,.gis-mapgj .gis-mapgj-circle img,.gis-mapgj .gis-mapgj-hand-hover img,.gis-mapgj .gis-mapgj-marquee-hover img,.gis-mapgj .gis-mapgj-diejia-hover img,.gis-mapgj .gis-mapgj-circle-hover img{position: absolute; left: 1px; top: -48px; -moz-user-select: none; border: 0px none; padding: 0px; margin: 0px; width: 16px;  cursor:pointer;}
.gis-mapgj .gis-mapgj-marquee img{top:-2px; right:4px; left:2px;}
.gis-mapgj .gis-mapgj-circle img{top:-98px; right:4px;}
.gis-mapgj .gis-mapgj-hand-hover img{top:-50px; right:4px; left:2px;}
.gis-mapgj .gis-mapgj-hand img{top:-76px; right:4px;left:2px;}
.gis-mapgj .gis-mapgj-marquee-hover img{top:-25px; right:4px; left:2px;}
.gis-mapgj .gis-mapgj-circle-hover img{top:-120px; right:4px;}
.gis-mapgj .gis-mapgj-diejia img{top:-144px; right:4px; left:2px;}
.gis-mapgj .gis-mapgj-diejia-hover img{top:-165px; right:4px; left:2px;}
...
div.messager-body.panel-body.panel-body-noborder.window-body{
	...
	<script>
		...
		var teleAuth = ${Session.user.teleAuth!}+"";
	</script>
