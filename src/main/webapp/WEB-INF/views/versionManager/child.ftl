			...
			<div class="form-body">
				...
				<div class="form-group" style="padding:10px 0px 0px 0;">
					...
					<div class="col-md-7 validateDiv">
						<input class="form-control ban" id="soft_ver" name="soft_ver" <#if bean?? && bean.id??>disabled = "true"</#if> type="text" style="width:160px;float:left;" placeholder="请输入版本名称" value="${(bean.soft_ver)!}" onkeyup="value=value.replace(/[^_a-zA-Z0-9.]/g,'')"/>
						<br/><br/>
