...
<div id="modal-backdrop" class="load" style="display:block;z-index: 11050;">
    <div class="load_pic">
    	<img src="${application.getContextPath()}/images/load-pic.png" width="30%" class="animationRotate">
        <span class="load_txt"><img src="${application.getContextPath()}/images/wo.png" width="30%"></span>
    </div>    
</div>
		<!-- BEGIN HEADER -->   
