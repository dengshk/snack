	...
	<div class="portlet-body form">
		<form class="form-horizontal form-bordered form-row-seperated" id="editOrderChild" method="post" onsubmit="return false;">
			<input name="id" type="hidden" id="id_child" value="${(saleOrder.id)!}"/>
			<div class="form-body">
				<!--产品名称-->
			...
			<div class="form-actions modal-footer">
				<button type="button" class="btn blue saveOrder" id="saveBtn" type="submit">确定</button>
