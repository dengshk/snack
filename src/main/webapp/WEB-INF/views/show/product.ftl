...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                    ...
                    <div class="portfolio-content portfolio-3">
                        ...
                        <div id="js-grid-lightbox-gallery" class="cbp">
                            <div class="cbp-item web-design graphic print motion">
                                <a href="${application.getContextPath()}/assets/global/plugins/cubeportfolio/ajax/project3.html" class="cbp-caption cbp-singlePageInline" data-title="World Clock Widget<br>by Paul Flavius Nechita" rel="nofollow">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="${application.getContextPath()}/assets/global/img/portfolio/600x600/01.jpg" alt=""> </div>
                            ...
                            <div class="cbp-item web-design logos identity graphic">
                                <a href="${application.getContextPath()}/assets/global/plugins/cubeportfolio/ajax/project4.html" class="cbp-caption cbp-singlePageInline" data-title="Bolt UI<br>by Tiberiu Neamu" rel="nofollow">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="${application.getContextPath()}/assets/global/img/portfolio/600x600/1.jpg" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignLeft">
                                            <div class="cbp-l-caption-body">
                            ...
                            <div class="cbp-item graphic print identity">
                                <a href="${application.getContextPath()}/assets/global/plugins/cubeportfolio/ajax/project3.html" class="cbp-caption cbp-singlePageInline" data-title="WhereTO App<br>by Tiberiu Neamu" rel="nofollow">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="${application.getContextPath()}/assets/global/img/portfolio/600x600/02.jpg" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignLeft">
                                            <div class="cbp-l-caption-body">
                            ...
                            <div class="cbp-item web-design motion logos">
                                <a href="${application.getContextPath()}/assets/global/plugins/cubeportfolio/ajax/project4.html" class="cbp-caption cbp-singlePageInline" data-title="iDevices<br>by Tiberiu Neamu" rel="nofollow">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="${application.getContextPath()}/assets/global/img/portfolio/600x600/2.jpg" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignLeft">
                                            <div class="cbp-l-caption-body">
                            ...
                            <div class="cbp-item identity graphic print">
                                <a href="${application.getContextPath()}/assets/global/plugins/cubeportfolio/ajax/project3.html" class="cbp-caption cbp-singlePageInline" data-title="Seemple* Music for iPad<br>by Tiberiu Neamu" rel="nofollow">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="${application.getContextPath()}/assets/global/img/portfolio/600x600/03.jpg" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignLeft">
                                            <div class="cbp-l-caption-body">
                            ...
                            <div class="cbp-item motion print logos web-design">
                                <a href="${application.getContextPath()}/assets/global/plugins/cubeportfolio/ajax/project4.html" class="cbp-caption cbp-singlePageInline" data-title="Remind~Me Widget<br>by Tiberiu Neamu" rel="nofollow">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="${application.getContextPath()}/assets/global/img/portfolio/600x600/3.jpg" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignLeft">
                                            <div class="cbp-l-caption-body">
                            ...
                            <div class="cbp-item graphic logos">
                                <a href="${application.getContextPath()}/assets/global/plugins/cubeportfolio/ajax/project3.html" class="cbp-caption cbp-singlePageInline" data-title="Workout Buddy<br>by Tiberiu Neamu" rel="nofollow">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="${application.getContextPath()}/assets/global/img/portfolio/600x600/04.jpg" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignLeft">
                                            <div class="cbp-l-caption-body">
                            ...
                            <div class="cbp-item identity print logos motion">
                                <a href="${application.getContextPath()}/assets/global/plugins/cubeportfolio/ajax/project4.html" class="cbp-caption cbp-singlePageInline" data-title="Digital Menu<br>by Cosmin Capitanu" rel="nofollow">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="${application.getContextPath()}/assets/global/img/portfolio/600x600/4.jpg" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignLeft">
                                            <div class="cbp-l-caption-body">
                            ...
                            <div class="cbp-item identity motion web-design">
                                <a href="${application.getContextPath()}/assets/global/plugins/cubeportfolio/ajax/project3.html" class="cbp-caption cbp-singlePageInline" data-title="Holiday Selector<br>by Cosmin Capitanu" rel="nofollow">
                                    <div class="cbp-caption-defaultWrap">
                                        <img src="${application.getContextPath()}/assets/global/img/portfolio/600x600/05.jpg" alt=""> </div>
                                    <div class="cbp-caption-activeWrap">
                                        <div class="cbp-l-caption-alignLeft">
                                            <div class="cbp-l-caption-body">
                        ...
                        <div id="js-loadMore-lightbox-gallery" class="cbp-l-loadMore-button">
                            <a href="${application.getContextPath()}/assets/global/plugins/cubeportfolio/ajax/loadMore3.html" class="cbp-l-loadMore-link btn grey-mint btn-outline" rel="nofollow">
        ...
        <div class="page-footer">
            <div class="page-footer-inner-self"> 2014 &copy; Metronic by keenthemes.
