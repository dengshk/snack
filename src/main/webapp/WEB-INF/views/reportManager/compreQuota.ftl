					...
					<!-- title-->
						<div class="portlet ">
							<div class="portlet-body">
								...
								<!-- 跳转地图查询条件 开始 -->
								<form id="linkMap" name="linkMap" action="${application.getContextPath()}/roadMap/roadMap?op_menu=9" method="post" >
								...
								<div class="table-responsive table-scrollable">
									<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
										...
										<tbody>
											...
											<#else>
												<tr>
													<td colspan="57"  align='center' style="height:37px;border-bottom:1px #dddddd  solid;">无采集数据</td>
												</tr>
											</#if>
											<!-- 表单内容 结束 -->
										</tbody>
